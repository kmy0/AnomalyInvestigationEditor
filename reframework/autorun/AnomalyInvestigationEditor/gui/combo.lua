...
function this:swap(key_to_value, current_index)
    if current_index and self.map then
        local current_item = self.map[current_index or 1]
        local current_key = current_item and current_item.key
